...
const CONTRACTS = [
  ...
  { file: 'screens/home-base.css', selector: '.home-content', properties: ['width', 'min-width', 'max-width', 'box-sizing', 'display', 'gap', 'padding'], values: { display: ['grid'] }, allowedFiles: ['screens/home-base.css', 'foundation/motion.css'] },

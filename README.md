...
📜 Changelog (업데이트 내역)
* [v1.2] 정식버전 (2026-04-17) : 1.1 업데이트 오류 수정

* [v1.1] 정식버전 (2026-04-13) : 3월 모의고사 성적반영 및 튜토리얼 적용

* [v1.0] 정식버전 (2026-04-09) : 스터디크랙 정식 출시 🚀
...
* [v2.0] Beta (2026-03-31) : 버전 분리 후 발생한 시스템 전반의 오류 수정

* [v1.0] Beta (2026-03-28) : 최초 환경 분리 및 베타 버전 배포

---

> **📅 Last Updated:** 2026년 4월 17일 (금) - 정식버전 1.2 배포 완료
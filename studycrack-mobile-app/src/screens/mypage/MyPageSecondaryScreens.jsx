...
function QnaComposerModal({ open, qnaDraftContent = '', qnaDraftTitle = '', qnaSubmitting = false }) {
  return (
    <Modal open={open} dismissAction="closeQnaComposer" panelClass="qna-modal" ariaLabel="1:1 문의 작성">
...
function NotificationDetail({ item }) {
  ...
  return (
    <Modal dismissAction="closeNotiDetail" ariaLabel="알림 상세" overlayClass="noti-detail-overlay" panelClass="noti-detail-modal">

export function TargetAllowance({ policy }) {
  ...
  return <div className="analysis-target-allowance" role="status">
    ...
    {!policy.unlimited && policy.remaining === 0 ? <button type="button" className="btn btn-secondary mini" data-action="goto" data-target="proIntro">요금제 확인하기</button> : null}
  </div>;
}

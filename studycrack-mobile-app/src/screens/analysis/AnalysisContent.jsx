  ...
  return (
    <div className="analysis-unified">
      <div className="card analysis-result-card">
        ...
        {showCalculationPrompt ? <div className="analysis-score-prompt"><p>저장된 성적과 희망 대학 기준으로 환산점수를 계산합니다.</p><button type="button" className="analysis-calculate-btn" data-action="calculateAnalysisScore">{analysisCalculationRequested ? '다시 계산하기' : '점수 계산하기'}</button></div> : <div className={`analysis-main-gauge-wrap ${scoreTierClass(currentScore)}`}>

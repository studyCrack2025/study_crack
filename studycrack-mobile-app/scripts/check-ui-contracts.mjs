...
assert.match(motionStyles, /\.app-screen\[data-screen\]\{animation:var\(--sc-page-enter,mobileScreenEnter\)/, 'Every registered app screen must share the screen-enter motion');

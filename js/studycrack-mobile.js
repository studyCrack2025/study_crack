...
※ 이용자는 언제든지 수신 거부를 할 수 있습니다.` }
  ...
  const screens = {
    ...
    authSignup: layout(appbar('회원가입', true) + `<div class="signup-page"><div class="signup-form-card">
      ...
      <div class="terms-card"><div class="terms-header"><input type="checkbox" data-action="toggleSignupTermsAll" data-field="signupTermsAll" ${signupTermsAll?'checked':''}/><span>약관 전체 동의</span></div><div class="terms-item"><label><input type="checkbox" data-action="toggleSignupTermsRequired" data-field="signupTermsStandard" ${signupTermsRequired?'checked':''}/> (필수) 표준이용약관 동의</label><button type="button" class="terms-link" data-action="openTermsModal" data-terms-type="standard">보기</button></div><div class="terms-item"><label><input type="checkbox" data-action="toggleSignupTermsRequired" data-field="signupTermsService" ${signupTermsRequired?'checked':''}/> (필수) 서비스 이용약관 조항 동의</label><button type="button" class="terms-link" data-action="openTermsModal" data-terms-type="service">보기</button></div><div class="terms-item"><label><input type="checkbox" data-action="toggleSignupTermsRequired" data-field="signupTermsPrivacy" ${signupTermsRequired?'checked':''}/> (필수) 개인정보 처리방침 동의</label><button type="button" class="terms-link" data-action="openTermsModal" data-terms-type="privacy">보기</button></div><div class="terms-item"><label><input type="checkbox" data-action="toggleSignupTermsRequired" data-field="signupTermsRefund" ${signupTermsRequired?'checked':''}/> (필수) 환불 규정 동의</label><button type="button" class="terms-link" data-action="openTermsModal" data-terms-type="refund">보기</button></div><div class="terms-item"><label><input type="checkbox" data-action="toggleSignupTermsMarketing" data-field="signupTermsMarketing" ${signupTermsMarketing?'checked':''}/> (선택) 마케팅 정보 수신 동의</label><button type="button" class="terms-link" data-action="openTermsModal" data-terms-type="marketing">보기</button></div></div>${openTermsType ? `<div class="terms-modal-backdrop" data-action="closeTermsModal"><div class="terms-modal" data-action="noopModal"><button class="terms-modal-close" data-action="closeTermsModal">×</button><p class="terms-modal-title">${TERMS_CONTENT[openTermsType]?.title || ''}</p><div class="terms-modal-body">${TERMS_CONTENT[openTermsType]?.body || ''}</div></div></div>` : ''}

...
function App() {
  ...
  const homeView = () => `<div class="brand-row"><p class="greeting">안녕하세요, 지민님</p><img class="brand-logo-sm" src="./assets/images/studycrack_logo_wo_bg.png" alt="logo"/></div>
    ...
    <div class="section stack-card"><div class="card compact"><p class="sub">학습 트래킹</p><div class="bar">주간 공부시간<div class="track"><i style="width:78%"></i></div><span>36h</span></div><div class="bar">평균 대비<div class="track"><i style="width:68%"></i></div><span>상위32%</span></div></div><div class="card compact"><p class="sub">최근 리포트</p><ul class="list"><li>5월 11일 종합 분석 리포트</li></ul></div><div class="card compact"><p class="sub">오늘 할 일</p><ul class="list"><li>수학 개념 120분</li><li>영어 독해 90분</li></ul></div></div>
    <div class="section"><button class="btn btn-primary" data-action="goto" data-target="proPlan">Pro 업그레이드</button></div>`;

  const screens = {
    splash: `<div class="phone"><div class="splash"><div class="logo-bolt">${i('bolt',true)}</div><img class="brand-logo" src="./assets/images/studycrack_logo_wo_bg.png" alt="logo"/><h1 style="margin:0;font-size:30px">스터디크랙</h1><img src="${CRACKY_SRC}" class="cracky-img cracky-lg" alt="크랙이"/><p>합격까지 가장 빠른 전략</p></div></div>`,
    ...
    weekly: layout(appbar('주간 점검', true) + `<div class="card"><p class="sub">플래너 수행률</p><p class="metric-sm">82%</p><div class="progress"><span style="width:82%"></span></div>${mascotBubble('수학 시간을 더 확보해볼까요?','md')}</div><button class="btn btn-primary" data-action="back">다음 주 계획 세우기</button>`, false),
    report: layout(appbar('프로 보고서', true) + `<div class="card"><span class="badge">Pro 플랜 전용</span><p class="sub">2주에 1회 제공</p><div class="card" style="padding:14px"><div style="display:flex;justify-content:space-between;align-items:center"><div><p class="metric-sm">D-11</p><p class="sub">5월 25일 (토)</p></div><img src="${CRACKY_SRC}" class="cracky-img cracky-md" alt="크랙이"/></div></div></div><div class="card"><ul class="list"><li data-action="goto" data-target="reportDetail">5월 11일 · 종합 분석 리포트</li><li>4월 27일 · 중간 분석 리포트</li></ul></div><div class="card compact"><p class="sub">이전 보고서</p><ul class="list"><li>5월 11일 · 종합 분석 리포트</li><li>4월 27일 · 중간 분석 리포트</li></ul></div><button class="btn btn-primary">PDF 다운로드</button>`, false),

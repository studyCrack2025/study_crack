...
function App() {
  ...
  const homeView = () => `<div class="home-dashboard home-container">
    ...
    <div class="section home-section">
      <div class="home-kpi-slider">
        <div class="home-kpi-track ${homeSlideMotion}" style="--home-slide-card:72%;--home-slide-gap:12px;--home-slide-x:calc(-${homeSlideIndex} * (var(--home-slide-card) + var(--home-slide-gap)) + ${homeDragOffset}px);--home-slide-transition:${homeDragOffset!==0?'0s':'transform .58s cubic-bezier(.22,.61,.36,1)'};">
        ${homeTargets.map((item) => `<button class="card home-kpi-card admission-card slider-card home-result-card-v3" style="flex:0 0 72%;min-width:72%;max-width:72%;" data-action="selectUniversity" data-target-major="${item.major}">
  ...
  const designV2StyleTag = `<style>
    ...
    .home-kpi-slider .slider-card{flex:0 0 var(--home-slide-card,72%);min-width:var(--home-slide-card,72%);max-width:var(--home-slide-card,72%);margin-right:0;min-height:0;}
    .home-kpi-slider .home-kpi-card.slider-card{flex:0 0 var(--home-slide-card,72%);max-width:var(--home-slide-card,72%);min-width:var(--home-slide-card,72%);}

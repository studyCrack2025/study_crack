...
function App() {
  ...
  const homeView = () => `<div class="home-dashboard home-container">
    ...
    <div class="section home-section">
      <div class="home-kpi-slider">
        <div class="home-kpi-track ${homeSlideMotion}" style="--home-slide-card-width:45vw;--home-slide-gap:12px;--home-slide-x:calc(-${homeSlideIndex} * (var(--home-slide-card-width) + var(--home-slide-gap)) + ${homeDragOffset}px);--home-slide-transition:${homeDragOffset!==0?'0s':'transform .72s cubic-bezier(.22,1,.36,1)'};">
  ...
  const designV2StyleTag = `<style>
    ...
    .home-kpi-slider .slider-card{flex:0 0 var(--home-slide-card-width,45vw) !important;flex-basis:var(--home-slide-card-width,45vw) !important;flex-shrink:0 !important;min-width:var(--home-slide-card-width,45vw) !important;max-width:var(--home-slide-card-width,45vw) !important;width:var(--home-slide-card-width,45vw) !important;margin-right:0;min-height:0;box-sizing:border-box;overflow:hidden;}
    .home-kpi-slider .home-kpi-card.slider-card{flex:0 0 var(--home-slide-card-width,45vw) !important;flex-basis:var(--home-slide-card-width,45vw) !important;flex-shrink:0 !important;max-width:var(--home-slide-card-width,45vw) !important;min-width:var(--home-slide-card-width,45vw) !important;width:var(--home-slide-card-width,45vw) !important;}

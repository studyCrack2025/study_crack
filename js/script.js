...
const COURSE_DATA = {
    ...
    standard: { title: "STANDARD PLAN", price: `<span class="original-price">정가 149,000원 / 4주</span> <span class="discount-price">특별 할인가 <strong class="highlight-price">49,000원</strong> / 4주 · 주당 환산 12,250원</span>`, desc: "매주 SKY 튜터의 플래너 피드백으로 학습을 체계적으로 관리합니다.", list: [ { text: "Basic 기능 모두 포함" }, { text: "SKY 튜터 주 1회 플래너 피드백" }, { text: "과목별 시간 배분 점검" }, { text: "목표 대학 기준 우선순위 제안" }, { text: "매주 플래너 제시" } ], bg: "assets/backgrounds/bg_standard.png", themeColor: "#2563EB", ctaHref: "/payment?plan=standard", ctaLabel: "STANDARD 선택하기" },
    pro: { title: "PRO PLAN", price: `<span class="original-price">정가 299,000원 / 4주</span> <span class="discount-price">특별 할인가 <strong class="highlight-price">149,000원</strong> / 4주 · 주당 환산 37,250원</span>`, desc: "STANDARD의 모든 기능에 정밀 분석과 심화 전략을 더합니다.", list: [ { text: "STANDARD 모든 기능 포함" }, { text: "현재 성적 및 학습 성향 바탕 목표 대학 합격컷 도달 위한 목표 성적 정밀 제시" }, { text: "내 점수에 가장 유리한 대학 정밀 역추적" }, { text: "상향 지원 중장기 로드맵" }, { text: "심화 합격 전략 리포트" }, { text: "학부모 공유용 전략 리포트" }, { text: "조건부 환급 혜택 제공" }, { text: "PRO 전용 보고서 미리보기 📄", action: "download", file: "assets/features/feat_pro_report.pdf" } ], bg: "assets/backgrounds/bg_pro.png", themeColor: "#E11D48", ctaHref: "/payment?plan=pro", ctaLabel: "PRO 선택하기" }
};
